...
namespace Protus.Data.Migrations
{
    ...
    [Migration("20210518213604_CodingExamplesScript")]
    partial class CodingExamplesScript
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Protus.Data.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Protus.Data.Entities.CodingExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Protus.Data.Entities.Example", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Protus.Data.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Protus.Data.Entities.SolvedCodingExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SolvedCodingExercises");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Protus.Data.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Protus.Data.Entities.Topic", b =>
                {
                    b.HasOne("Protus.Data.Entities.Course", "Course")
                        .WithMany("Topics")
